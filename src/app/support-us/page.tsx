...
function SponsorshipTierMobile({
  ...
  return (
    <Box
      ...
      color={gradientColor}
      borderRadius="1.3rem"
      className={`flex flex-col w-full select-none transition-all duration-400 p-[1rem] cursor-pointer
    ${isExpanded ? "max-h-[100rem]" : "max-h-[3.65rem] md:max-h-[3.9rem]"}
  `}
      action={() => {
        setExpanded(!isExpanded);
      }}
    >
      <div className="flex flex-col items-center justify-center">
        <div className="grid grid-cols-3 h-full w-full items-center justify-center mx-[0.5rem] mb-[0.5rem]">
          <h5
            className="mr-auto font-semibold text-[1.25rem]/[1.25rem] md:text-[1.5rem]/[1.5rem]"
            style={{ color: textColor }}
          >
            {name}
          </h5>
          <h5
            className="font-semibold text-[1.25rem]/[1.25rem] md:text-[1.5rem]/[1.5rem] ml-auto"
            style={{ color: textColor }}
          >
            ≥ {priceThreshold} EUR
          </h5>
          <motion.div
            ...
            className="flex items-center justify-center ml-auto h-[1.75rem] w-[1.75rem]"
          >
            <IoIosArrowDown
        ...
        <ul
          className="pl-[2rem] mt-[1rem] list-disc transition-all duration-400 font-medium text-[1.1rem]/[1.35rem] md:text-[1.25rem]/[1.5rem] mb-[1rem] mr-auto"
          style={{
