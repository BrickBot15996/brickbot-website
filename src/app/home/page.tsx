        ...
        <div className="flex flex-col items-start justify-center h-full w-full bg-[linear-gradient(70deg,_#000000_30%,_transparent)] px-6">
          <div className="text-[#ffd100] font-extrabold z-10 ml-[2vw]">
            ...
            <Link href="/support-us">
              <button className="mt-4 bg-[linear-gradient(180deg,_#7D6800_0%,_#413400_50%)] text-[#ffd100] font-extrabold text-[2.25vh] px-[1vh] py-[0.5vh] rounded-[1.625vh]  border-[0.25vh] border-[#ffd100] hover:opacity-75 hover:scale-110 transition-transform duration-300">
                BECOME A SPONSOR
              </button>
            </Link>
          </div>
