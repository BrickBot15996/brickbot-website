        ...
        <div className="flex flex-row items-center justify-center w-[var(--page-width)] space-x-[var(--md-space-x)] h-full my-[var(--2xl-space-y)]">
          <div className="flex flex-col items-start justify-start">
            <div className="flex flex-row space-x-[var(--md-space-x)] items-center mb-[var(--md-space-y)] h-fit">
              ...
              {showProjectBadge && (
                <div className="bg-[var(--default-dark)] border-[0.075rem] border-[#ffffff80] rounded-full px-[1.5rem] lg:px-[1.9rem] text-[#ffffff80] text-[1rem] md:text-[1.2rem] lg:text-[1.4rem] py-[0.1rem] font-semibold h-fit select-none">
                  {t("tag")}
                </div>
              )}
            </div>
