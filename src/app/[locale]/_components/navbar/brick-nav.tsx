...
export function LanguageToggle() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 transition-opacity duration-200 bg-[#1A1A1A] border-[#ffffff80] rounded-full border-[0.15rem]">
        <div className="w-full h-full bg-[#ffffff] opacity-0 group-hover:opacity-5 group-active:opacity-10 rounded-full" />
      </div>

      <div
        className="relative z-2 h-full w-full px-[1.2rem] text-[#ffffff80] py-[0.1rem] font-semibold"
