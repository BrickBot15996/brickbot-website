export default function PageTitle({ title }: { title: string }) {
  return (
    <section className="relative bg-[linear-gradient(180deg,_transparent,_#201C03)] h-[12rem] md:h-[15rem] lg:h-[18rem] w-[100vw] flex flex-col items-center justify-center overflow-visible">
