...
export const useDecode = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/decode/logo.webp",
    awards: [
      {
        event: t("0.event"),
...
export const useIntoTheDeep = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/into-the-deep/logo.webp",
    awards: [
      {
        event: t("0.event"),
        awardName: t("0.awardName"),
...
export const useCenterstage = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/centerstage/logo.webp",
    awards: [
      {
        event: t("0.event"),
        awardName: t("0.awardName"),
...
export const usePowerplay = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/powerplay/logo.webp",
    awards: [
      {
        event: t("0.event"),
        awardName: t("0.awardName"),
...
export const useFreightFrenzy = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/freight-frenzy/logo.webp",
    awards: [
      {
        event: t("0.event"),
        awardName: t("0.awardName"),
...
export const useUltimateGoal = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/ultimate-goal/logo.webp",
    awards: [
      {
        event: t("0.event"),
        awardName: t("0.awardName"),
...
export const useSkystone = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/skystone/logo.webp",
    awards: [
      {
        event: t("0.event"),
        awardName: t("0.awardName"),
...
export const useRoverRuckus = (): SeasonProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/seasons/rover-ruckus/logo.webp",
    awards: [
      {
        event: t("0.event"),
        awardName: t("0.awardName"),
...
export const useRelicRecovery = (): SeasonProps => {
  return {
    ...
    logoPath: CDN_LINK + "/seasons/relic-recovery/logo.webp",
    awards: [],
  };
};
...
export const useVelocityVortex = (): SeasonProps => {
  return {
    ...
    logoPath: CDN_LINK + "/seasons/velocity-vortex/logo.webp",
    awards: [],
  };
};
