...
export const useSponsorList = (): SponsorData[] => {
  ...
  return [
    {
      name: "Micromet",
      logoPath: CDN_LINK + "/sponsors/micromet.webp",
      websiteLink: "https://www.micromet.ro/",
      tier: ultimate,
    },
    {
      name: "UMB Grup",
      logoPath: CDN_LINK + "/sponsors/umb.webp",
      websiteLink: "https://www.facebook.com/p/UMB-GRUP-100063895189860/",
      tier: ultimate,
    },
    {
      name: "Rikora",
      logoPath: CDN_LINK + "/sponsors/rikora.webp",
    ...
    },
    {
      ...
      logoPath: CDN_LINK + "/sponsors/fundatia-fan.webp",
      websiteLink: "https://fundatiafancourier.ro/",
      tier: diamond,
    },
    {
      name: "Remat Holding",
      logoPath: CDN_LINK + "/sponsors/remat.webp",
      websiteLink: "https://rematholding.ro/",
      tier: diamond,
    },
    {
      name: "Vrancart Group",
      logoPath: CDN_LINK + "/sponsors/vrancart.webp",
      websiteLink: "https://vrancart.ro/",
      tier: diamond,
    },
    {
      name: "Roman's",
      logoPath: CDN_LINK + "/sponsors/romans.webp",
      websiteLink: "https://romans.ro/",
      tier: diamond,
    },
    {
      name: "Paco Supermarket ",
      logoPath: CDN_LINK + "/sponsors/paco.webp",
    ...
    {
      name: "Reina Bijou",
      logoPath: CDN_LINK + "/sponsors/reina.webp",
      websiteLink: "http://www.reinabijou.ro/",
      tier: gold,
    },
    {
      name: "Zaga Zaga",
      logoPath: CDN_LINK + "/sponsors/zaga-zaga.webp",
      websiteLink: "https://zagazaga.ro/",
      tier: gold,
    },
    {
      name: "Idna Power",
      logoPath: CDN_LINK + "/sponsors/idna-power.webp",
      websiteLink: "https://idnasolarpower.ro/",
      tier: gold,
    },
    {
      name: "Arcmode",
      logoPath: CDN_LINK + "/sponsors/arcmode.webp",
    ...
    {
      name: "Allvet",
      logoPath: CDN_LINK + "/sponsors/allvet.webp",
      websiteLink: "http://allvet.ro/",
      tier: silver,
    },
    {
      name: "Diacarn",
      logoPath: CDN_LINK + "/sponsors/diacarn.webp",
      websiteLink: "https://diacarnfood.ro/",
      tier: silver,
    },
    {
      name: "Rix Rooms",
      logoPath: CDN_LINK + "/sponsors/rixrooms.webp",
    ...
    },
    {
      ...
      logoPath: CDN_LINK + "/sponsors/edil-dan-construct.webp",
    ...
    {
      name: "DataHost",
      logoPath: CDN_LINK + "/sponsors/datahost.webp",
