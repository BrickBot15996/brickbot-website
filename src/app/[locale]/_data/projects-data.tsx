...
export const useTheVault = (): ProjectProps => {
  ...
  return {
    ...
    logoPath: CDN_LINK + "/projects/the-vault/logo.svg",
    iconPath: CDN_LINK + "/projects/the-vault/icon.svg",
...
export const useCheckpoint = (): ProjectProps => {
  ...
  return {
    ...
    subtitle: t("subtitle"),
    description: t("description"),
    logoPath: CDN_LINK + "/projects/checkpoint/logo.svg",
    iconPath: CDN_LINK + "/projects/checkpoint/icon.svg",
...
export const useSparks = (): ProjectProps => {
  ...
  return {
    ...
    subtitle: t("subtitle"),
    description: t("description"),
    logoPath: CDN_LINK + "/projects/sparks/logo.svg",
    iconPath: CDN_LINK + "/projects/sparks/icon.svg",
...
export const useBrickDocs = (): ProjectProps => {
  ...
  return {
    ...
    subtitle: t("subtitle"),
    description: t("description"),
    logoPath: CDN_LINK + "/projects/brickdocs/logo.svg",
    iconPath: CDN_LINK + "/projects/brickdocs/icon.svg",
...
export const useSimplicityFTC = (): ProjectProps => {
  ...
  return {
    ...
    subtitle: t("subtitle"),
    description: t("description"),
    logoPath: CDN_LINK + "/projects/simplicityftc/logo.svg",
    iconPath: CDN_LINK + "/projects/simplicityftc/icon.svg",
