  ...
  return (
    <div className="h-[6vh] bg-[#121212] flex justify-center items-center text-[#ffffff] font-bold text-[2vh] overflow-visible">
      <div className="flex justify-center items-center w-full max-w-screen-xl px-4 mx-auto space-x-[3vw]">
        <Link
          href="/tbd"
          className="hover:opacity-75 hover:scale-105 transition-transform duration-150"
        >
          TBD
        </Link>
        <Link
        ...
        <Link
          href="/home"
          className="relative z-10 hover:opacity-75 hover:scale-105 transition-transform duration-150"
        >
          <Image
