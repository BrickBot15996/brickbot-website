      ...
      <span className="relative h-auto ml-auto mr-[1.5rem] md:mr-[3rem] lg:mr-[5rem] mt-[3rem] md:mt-[3.5rem] lg:mt-[4rem] w-fit select-none">
        <div className="grid grid-cols-4 items-start space-x-[1rem] pt-[0.25rem] mr-[-1rem]">
          ...
          <Link
            ...
            target="_blank"
          >
            <RiFacebookBoxLine className="hover:opacity-75 hover:scale-110 active:opacity-100 active:scale-90 h-[1.5rem] md:h-[2.5rem] lg:h-[3rem] w-auto transition-transform duration-150" />
          </Link>
          <Link
            href="https://www.youtube.com/channel/UCRpA5UNXSZDl2GmPt_E91ew"
            target="_blank"
          >
            <RiYoutubeLine className="hover:opacity-75 hover:scale-110 active:opacity-100 active:scale-90 h-[1.5rem] md:h-[2.5rem] lg:h-[3rem] w-auto transition-transform duration-150" />
          </Link>
          <Link
          ...
          >
            <Image
              ...
              width={24}
              height={24}
              className="hover:opacity-75 hover:scale-110 active:opacity-100 active:scale-90 h-[1.5rem] md:h-[2.5rem] lg:h-[3rem] w-auto transition-transform duration-150"
            />
          </Link>
        </div>
      </span>
