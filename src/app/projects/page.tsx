  ...
  return (
    ...
    >
      <div className="inline-flex h-full w-full p-[2rem] gap-x-[2rem] items-center justify-center">
        <div
          className="h-full w-full hover:scale-105 hover:brightness-75 active:scale-95 active:brightness-100 transition-transform duration-200 cursor-pointer"
          onClick={() => {
        ...
        <div className="flex-[0_0_60%] lg:flex-[0_0_75%] xl:flex-[0_0_80%] 2xl:flex-[0_0_85%] flex flex-col justify-center">
          <h3
            className="text-[1.5rem]/[2rem] md:text-[1.75rem]/[2.25rem] xl:text-[2rem]/[2.5rem] mr-auto font-bold hover:underline cursor-pointer"
