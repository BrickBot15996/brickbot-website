...
function Project({
  ...
  useEffect(() => {
    const handleResize = () => {
      const medium = window.innerWidth < 1024 && window.innerWidth >= 768;
      setIsMobile(medium);
    };
      ...
      >
        {isMobile && (
          <div className="flex flex-col h-full w-full p-[2rem] space-y-[1rem] items-center justify-center">
            <h3
              className="text-[1.5rem]/[2rem] md:text-[1.75rem]/[2.25rem] mr-auto font-bold group-hover:brightness-120"
